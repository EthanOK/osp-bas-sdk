...
var require_client6 = __commonJS({
  "node_modules/@alicloud/openapi-client/dist/client.js"(exports) {
    ...
    exports.GlobalParameters = GlobalParameters2;
    var Config2 = class extends $tea.Model {
      constructor(map) {
        super(map);
      }
...
function getPrivateKeyByKms() {
  return __async(this, null, function* () {
    try {
      ...
      const privateKey2 = ethers2.Wallet.fromPhrase(mnemonic).privateKey;
      return privateKey2;
    } catch (e) {
      console.log(e);
      return "";
...
var multiAttestBasUploadGreenField = (bucketName, schemaUID, unHandleDatas, isPrivate, quota_GB) => __async(void 0, null, function* () {
  try {
    ...
    const signer = new ethers4.Wallet(
      privateKey2,
      new ethers4.JsonRpcProvider(basConfig2.RPC_URL)
    );
...
var getDeployer = () => __async(void 0, null, function* () {
  const provider = new ethers5.JsonRpcProvider(process.env.RPC_URL);
